const airports = [
    ...
    {
        "name": "Nexitally奶昔",
        "slogan": "奶昔机场是一家提供稳定翻墙节点的老牌翻墙VPN机场，提供高速 Shadowsocks 和 Trojan 专用翻墙节点，通过国内BGP服务器接入，专线出墙，高质量线路，属于稳定机场的行列。",
        "url": "https://s.yanet.app/rhmRPe",
        "features": ["周期付费", "解锁流媒体", "中转", "gpt", "ss", "trojan", "bgp"],
        "coupons": []
    },
    {
        "name": "极客云",
        "slogan": "是一家专业的SSR/V2Ray机场，多年老站，拥有近70个付费节点，全部使用CN2/BGP隧道中转和IPLC国际专线，套餐灵活，性价比高。",
        "url": "https://s.yanet.app/LsdrxS",
        "features": ["周期付费", "解锁流媒体", "中转", "gpt", "ss", "v2ray", "iplc", "bgp", "cn2"],
        "coupons": []
    },
    {
        "name": "AirRcoket",
        "slogan": "✔️包月价格9.9✔️注册可试用。全中转4k秒开，GPT等全解锁1",
        "url": "https://s.yanet.app/1V6b2O",
        "features": ["周期付费", "解锁流媒体", "中转", "gpt", "ss", "不限速", "不限设备数量"],
        "coupons": []
    },
    {
        "name": "青云梯",
        "slogan": "70+节点，高端节点，海外团队，安全可靠。所有节点x1倍率，晚高峰不限速，全IPLC专线，最大提供2.5GBPs速率。",
        "url": "https://s.yanet.app/xYsGs5",
        "features": ["周期付费", "解锁流媒体", "中转", "gpt", "ss", "不限速", "不限设备数量", "iplc"],
        "coupons": []
    },
    {
        "name": "TLS",
